...
router.get('/listings/pending', auth, requireAdmin, async (req, res) => {
  try {
    const query = `
      SELECT 
        l.*,
...
// İlanı onayla
router.put('/listings/:id/approve', auth, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
// İlanı reddet
router.put('/listings/:id/reject', auth, requireAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
// Toplu onaylama
router.put('/listings/bulk-approve', auth, requireAdmin, async (req, res) => {
  try {
